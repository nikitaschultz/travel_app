  ...
  render(){
    ...
    return (
      <div className="trip">
        ...
        <PlanContainer fetchHolidays={this.props.fetchHolidays} selectedTrip={this.props.selectedTrip} plans={this.props.trip.plans} handleTripSelected={this.props.handleTripSelected} trip={this.props.trip} />
      </div>
    )
  }
}
